...
# Definir rota para o arquivo JSON normal
df = pd.read_json('data\data.json')

# Exibir todas as colunas no terminal
pd.options.display.max_columns = None

# Adicionar coluna source com um valor fixo
...
# Remover os parênteses do reviews_amount
